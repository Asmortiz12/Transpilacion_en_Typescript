...
function saludar(persona: string, edad: string, nCarrera: string, nivel: string): void {
    document.write(`<br>Hola ${persona}<br> Con edad: ${edad}<br> Que estudia ${nCarrera}<br> Que esta en: ${nivel}<br>`);
}
...
var Cliente1:Cliente = new Cliente("Juan","0925456564556", 56);
function saludarAjuan(Cliente1 : Cliente){
